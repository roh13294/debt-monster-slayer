...
import { Coins, CalendarDays, Sparkles } from 'lucide-react';
  ...
  return (
    <div className="relative space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        <div className="card-elegant bg-gradient-to-br from-green-50 to-blue-50 flex flex-col justify-between">
          <div>
        ...
        <div className="card-elegant bg-gradient-to-br from-indigo-50 to-purple-50 flex flex-col justify-between">
          <div>
        ...
        <div className="card-elegant bg-gradient-to-br from-yellow-50 to-orange-50 flex flex-col justify-between">
          <div>
            <h3 className="text-sm font-medium text-gray-500 mb-2">Game Progress</h3>
            <div className="flex items-center">
              <Sparkles className="h-6 w-6 text-yellow-500 mr-2" />
              <span className="text-2xl font-bold text-yellow-600">{specialMoves} Special Moves</span>
            </div>
          </div>
          <div className="mt-4">
            <Button 
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="md:col-span-2 space-y-6">
          <div className="card-elegant">
            <h2 className="text-xl font-bold mb-4">Your Debt Monsters</h2>
            {debts.length === 0 ? (
              <div className="text-center py-8 bg-gray-50 rounded-lg">
                <p className="text-gray-500">You have no debts! Great job!</p>
              </div>
            ) : (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="card-elegant">
              <h2 className="text-lg font-bold mb-3">Strategy</h2>
              <StrategySelector />
            </div>
        ...
        <div className="space-y-6">
          <div className="card-elegant">
            <h2 className="text-lg font-bold mb-3">Active Challenge</h2>
            <Challenge 
          ...
          <div className="card-elegant">
            <h2 className="text-lg font-bold mb-3">Helpful Tips</h2>
